...
App.crossExamPrep = { result: null, isRunning: false, job: null, events: [], stream: null, startedAt: null, history: [] };
...
function switchView(name, options = {}) {
  ...
  if (name === 'cross-exam-prep') loadV2ShellData().then(renderCrossExamPrep).catch(() => renderCrossExamPrep());
