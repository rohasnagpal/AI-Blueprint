...
BUILTIN_CONTRACT_WORKFLOW_MODULES: tuple[ContractWorkflowModule, ...] = (
    ...
    ContractWorkflowModule("playbook_comparison", "Playbook Comparison", "comparison", 30, "sequential", "rules_first", "ContractClause[] + ContractPlaybook", "PlaybookFindingResult[]"),
    ContractWorkflowModule("risk_scoring", "Risk Scoring", "risk", 40, "sequential", "rules_first", "ContractClause[] + PlaybookFindingResult[]", "RiskFindingResult[]"),
