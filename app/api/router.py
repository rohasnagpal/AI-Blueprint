...
router.include_router(arbitration_prep.router)
router.include_router(litigation_prep.router)
router.include_router(mediation_prep.router)
router.include_router(negotiation_prep.router)
