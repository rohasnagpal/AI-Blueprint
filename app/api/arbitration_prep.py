...
def _execute_arbitration_prep(
    ...
    *,
    ...
    agentic = run_agentic_arbitration_prep(sources=sources, source_bundle=source_bundle, run_context=config, settings=settings, progress_callback=progress if job else None)
